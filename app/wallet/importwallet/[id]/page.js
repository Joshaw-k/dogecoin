...
export default function page() {
  ...
  const HandleWallet = () => {
    ...
    tabs.forEach((tab, index) => {
      if (tab.id == tabs[0].id) {
        tab.classList.add("tabActive", "bg-[#FBD869]", "text-white");
        tab.classList.remove("text-[#5B5B5B]");
      }

      tab.addEventListener("click", (e) => {
        tabs.forEach((tab) => {
          tab.classList.remove("tabActive", "bg-[#FBD869]", "text-white");
    ...
    <div>
      <div className="pb-20 pt-6">
        <div className="flex items-center">
          <div className="max-w-xl mx-auto mt-24 md:mt-10 w-[90%] bg-[#9022FF] px-8 pt-10 pb-10 rounded-3xl">
                ...
                <div>
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex font-urbanist justify-between items-center mt-5">
                      ...
                      <button
                        className="bg-[#FBD869] py-5 w-[48%] rounded-full text-[#222222] font-bold"
                        type="submit"
